...
export type Events = 'rateLimit' | 'ready' | 'resumed' | 'guildCreate' | 'guildDelete' | 'guildUpdate' | 'inviteCreate' | 'inviteDelete'
  ...
  | 'emojiUpdate' | 'guildBanAdd' | 'guildBanRemove' | 'channelCreate' | 'channelDelete' | 'channelUpdate' | 'channelPinsUpdate'
  | 'message' | 'messageDelete' | 'messageUpdate' | 'messageDeleteBulk' | 'messageReactionAdd' | 'messageReactionRemove'
